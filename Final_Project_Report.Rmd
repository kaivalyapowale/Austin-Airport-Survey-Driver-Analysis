---
title: "Team 2 : Final Project Report"
...
We collected the survey data of passengers traveling from the Austin-Bergstrom International Airport. The data was obtained from the US Government website: data.gov.
...
```{r}
survey.plan <- survey_imputed[ which(survey_imputed$Departure.time=="Early Morning"), ]
hist(survey.plan$Overall.satisfaction, main="Overall Satisfaction in Early Morning")

survey.plan <- survey_imputed[ which(survey_imputed$Departure.time=="Morning"), ]
hist(survey.plan$Overall.satisfaction, main="Overall Satisfaction in Morning")

survey.plan <- survey_imputed[ which(survey_imputed$Departure.time=="Day"), ]
hist(survey.plan$Overall.satisfaction, main="Overall Satisfaction in Day")

survey.plan <- survey_imputed[ which(survey_imputed$Departure.time=="Evening"), ]
hist(survey.plan$Overall.satisfaction, main="Overall Satisfaction in Evening")

survey.plan <- survey_imputed[ which(survey_imputed$Departure.time=="Night"), ]
hist(survey.plan$Overall.satisfaction, main="Overall Satisfaction in Night")
```
